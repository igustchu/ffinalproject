...
import '../widgets/custom_header.dart'; // ใช้ Header เดิมที่มี
...
class _InventoryScreenState extends State<InventoryScreen> {
  ...
  // Stream ดึงข้อมูลจาก Supabase แบบ Realtime
  final _ingredientsStream = Supabase.instance.client
      .from('ingredients')
      .stream(primaryKey: ['id'])
      .order('expiry_date', ascending: true); // เรียงตามวันหมดอายุ
  ...
  Widget _buildInventoryCard(Map<String, dynamic> item) {
    ...
    final maxQuantity =
        item['max_quantity'] ?? quantity; // ถ้าไม่มี max ให้ใช้ current
